...
CodonsDF<-read.csv("/Users/Janina/sciebo/Master.LGTs/all.start.stop.codons.tsv", sep=";", header=F)
...
# Upload the file including the codons and change it to merge it accordingly
reannotatedCodonsDF<-read.csv("/Users/Janina/Documents/MASTER/Masterarbeit/lgt/0_data/all.reannotated.start.stop.codons.tsv", sep=";", header=F)
...
write_xlsx(Final.Locuslevel.df,"/Users/Janina/Documents/MASTER/Masterarbeit/lgt/0_data/LGTs.LocusLevel.Expression.Reannotation.xlsx")
```


```{r}
### Add reannotation to CDS level final df
Final.Locuslevel.df<-read_xlsx("/Users/Janina/Documents/MASTER/Masterarbeit/lgt/0_data/LGTs.LocusLevel.Expression.Reannotation.xlsx")
...
# Save the CDS level table including expression and dfast results 
write_xlsx(Final.CDSlevel.df,"/Users/Janina/Documents/MASTER/Masterarbeit/lgt/0_data/LGTs.CDSLevel.Expression.Reannotation.xlsx")

write.table(Final.CDSlevel.df,"/Users/Janina/Documents/MASTER/Masterarbeit/lgt/0_data/LGTs.CDSLevel.Expression.Reannotation.tsv",sep="\t",quote = F,row.names = F)
```