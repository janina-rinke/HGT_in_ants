...
LGT.anks.lys<-LGT.anks.lys[,c(25,27)]
...
tp6 <- tp5.5 +
  ...
  geom_fruit(
     ...
     scale_fill_manual(
       values=c("black","blue","lightblue","grey"),          #color of the external geom_layer
...
ggsave("/Users/Janina/Documents/MASTER/Masterarbeit/plots/GAGA_phylogenies/GAGA.phylogeny.proteins.bacteria.legend.pdf",width=20,height=25) #save the tree in a pdf
