...
gsub(df$.id,"\\..*","") #separate the first row of df to merge by column ".id"


# Merge dscf together with the information for every LGT candidate 
tryout_df<- merge(dscf, df, by=".id","cand.scaffold")
