...
```{r}
library(readxl)
df_analysis<-read.csv2("/Users/Janina/Documents/MASTER/Masterarbeit/lgt/0_data/LGTs.CDSLevel.UniProt.Info.tsv", sep="\t")
...
ggsave("/Users/Janina/Documents/MASTER/Masterarbeit/plots/self_produced/q_cov_vs_s_cov.pdf", p, width=20, height=10)
```
...
ggsave("/Users/Janina/Documents/MASTER/Masterarbeit/plots/self_produced/s_cov_vs_pid.pdf", p0.1, width=20, height=10)
...
library(readxl)
Reannotated.df<-read_xlsx("/Users/Janina/Documents/MASTER/Masterarbeit/lgt/0_data/LGTs.CDSLevel.Expression.Reannotation.xlsx")
```
...
write.table(df.re.final,"/Users/Janina/Documents/MASTER/Masterarbeit/lgt/0_data/LGTs.CDSLevel.UniProt.Info.Reannotated.tsv", sep="\t", quote = FALSE,row.names=FALSE)
```
...
write.table(df.re.locuslevel,"/Users/Janina/Documents/MASTER/Masterarbeit/lgt/0_data/LGTs.LocusLevel.UniProt.Info.Reannotated.tsv", sep="\t", quote = FALSE,row.names=FALSE)
```