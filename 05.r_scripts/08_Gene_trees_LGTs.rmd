...
```{r}
tree <- read.tree("/Users/Janina/Documents/MASTER/Masterarbeit/lgt/0_data/trees/Lyzozymes_singleCDS_bacteria.aln.treefile")
```
...
all_info$type[grep("GAGA",all_info$id)]<-"LGT"
