...
ggsave("/Users/Janina/sciebo/Publications/HGT_Manuscript/ANKs.expression.pid.correlation.pdf",plot=p.ANKs, width=10, height=6)
```
...
write.table(Nr.species.ANKs, file='/Users/Janina/sciebo/HGT_Manuscript/Dataframes/Species_with_ANKs.tsv', quote=FALSE, sep=',', row.names = F)
```
