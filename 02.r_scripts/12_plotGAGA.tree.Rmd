...
```{r}
# Whole tree
GAGA.tree<-load("/Users/Janina/sciebo/MASTER/Masterarbeit/lgt/0_data/trees/GAGA.tree.plot4.Robject")
...
GAGA.data<-read.table("/Users/Janina/sciebo/MASTER/Masterarbeit/lgt/0_data/Tables/GAGA.data.tsv",sep="\t",T)
GAGA.all.data<-read.table("/Users/Janina/sciebo/MASTER/Masterarbeit/lgt/0_data/Tables/all.GAGA.data.tsv",sep="\t",T)
```
