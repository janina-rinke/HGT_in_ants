...
#basedir<-"/Users/lukas/sciebo/Projects/LGT/JaninaRinke/data/dfast/" #adjust folder to your settings
basedir<-"/Users/Janina/sciebo/Master.LGTs/dfast/"
...
#ggsave("/Users/Janina/Documents/MASTER/Masterarbeit/plots/Completeness.LGT.candidates.pdf",width=15,height=30) 
```
...
#ggsave("/Users/Janina/Documents/MASTER/Masterarbeit/plots/Secondplot.LGT.candidates.pdf") 
```

#  Merge the q_cov and s_cov data columns with the LGT candidate dataframe

```{r}
LGTs.all<-read_excel("/Users/Janina/Documents/MASTER/Masterarbeit/lgt/0_data/GAGA.LGT.162.resulting.good.single.candidates.filtered.xlsx")
...
#write.table(LGTs.plus,file="/Users/Janina/Documents/MASTER/Masterarbeit/lgt/0_data/LGTs.all.candidates.completeness.tsv", quote=FALSE, sep='\t',row.names=FALSE)
```
