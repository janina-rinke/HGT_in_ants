...
GAGA.data<-read.table("/Users/Janina/sciebo/MASTER/Masterarbeit/lgt/0_data/Tables/all.GAGA.data.tsv",sep="\t",T)

# Load tree itself
GAGA2.tree<-read.tree("/Users/Janina/sciebo/MASTER/Masterarbeit/lgt/0_data/trees/GAGA_dated_phylogeny_newick_woutgroup_DatesPeters2017_CurrBio.tre")
```
...
LGTs<-read_excel("/Users/Janina/sciebo/MASTER/Masterarbeit/lgt/0_data/Tables/LGTs.LocusLevel.UniProt.Info.Reannotated.xlsx")
```
...
p6
#ggsave(p6,file="/Users/Janina/Documents/MASTER/Masterarbeit/plots/GAGA_dated_phylogenies/GAGA.phylogeny.LGTs.dots.pdf",width = 12,height=24) #save the tree in a pdf
...
```{r}
LGT.bacteria<-read_excel("/Users/Janina/sciebo/MASTER/Masterarbeit/lgt/0_data/Tables/LGTs.LocusLevel.Expression.xlsx")[,c(1,2,17,16,15,12,13)]
...
ggsave("/Users/Janina/sciebo/HGT_Manuscript/Figures/GAGA.new.phylo.HGTs.pdf", width=20, height=25)
...
write.csv(LGT.complete, "/Users/Janina/sciebo/MASTER/Masterarbeit/lgt/0_data/Tables/497_HQ_LGTs_all_info.csv", row.names=FALSE)
write.xlsx(LGT.complete,"/Users/Janina/sciebo/MASTER/Masterarbeit/lgt/0_data/Tables/497_HQ_LGTs_all_info.xlsx")
```
...
```{r}
# Load data
preCurated.LGTs<-read_excel("/Users/Janina/sciebo/MASTER/Master.LGTs/0_data/Tables/GAGA.HGTs.afterFiltering.all.genomes.xlsx")
...
write.xlsx(preCurated.LGTs,"/Users/Janina/sciebo/HGT_Manuscript/Supplementary Data/Supplementary Tables/GAGA.HGTs.afterFiltering.all.genomes.xlsx")
```
...
ggsave("/Users/Janina/sciebo/HGT_Manuscript/Supplementary Data/Supplementary Figures/GAGA.preCurated.HGTs.pdf")
````
