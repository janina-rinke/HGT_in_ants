...
```{r}
LGT.bacteria<-read_excel("/Users/Janina/sciebo/MASTER/Masterarbeit/lgt/0_data/Tables/LGTs.LocusLevel.Expression.xlsx")[,c(15,2)]
...
tp2<-tp2+scale_fill_manual(values=c("grey20","grey60","grey80","grey90"))
